...
const RentModal = () => {
  ...
  let bodyContent = (
    ...
    if(step===STEPS.IMAGES) {
      bodyContent = (
        <div className="flex flex-col gap-8">
            <Heading title="Add a photo toy your place" subtitle="Show guesta the images of your place"/>
            <ImageUpload
            value={imageSrc}
    ...
    if(step===STEPS.DESCRIPTION) {
      bodyContent = (
        <div className="flex flex-col gap-8">
          <Heading title="How woluld you describe your place" subtitle="Short and sweet works best"/>
          <Input
          id="title"
          label="title"
          disabled={isLoading}
